...
import loginAPI from "../services/features/auth/loginAPI";
...
const Login = () => {
  ...
  const handleSubmit = async(e: React.FormEvent) => {
     ...
     const data = await loginAPI({username: formData.username, password: formData.password, email: formData.email, setErrorMessage});
